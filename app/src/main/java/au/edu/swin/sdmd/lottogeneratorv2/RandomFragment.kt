...
class RandomFragment : Fragment() {
    ...
    private val lottoList = mutableListOf<Lotto>(
        Lotto(Random.nextInt(1,35),Random.nextInt(1,35),
            Random.nextInt(1,35),Random.nextInt(1,35),
            Random.nextInt(1,35),Random.nextInt(1,35),
            Random.nextInt(1,35),Random.nextInt(1,20))
    )
    ...
    override fun onCreateView(
        ...
        btnRandom.setOnClickListener{
            lottoList.add((Lotto(Random.nextInt(1,35),Random.nextInt(1,35),
                Random.nextInt(1,35),Random.nextInt(1,35),
                Random.nextInt(1,35),Random.nextInt(1,35),
                Random.nextInt(1,35),Random.nextInt(1,20))))
